...
use Appsaeed\Mock\Connection;
use Appsaeed\Mock\WampComponent as TestComponent;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Appsaeed\Wamp\ServerProtocol
 * @covers \Appsaeed\Wamp\WampServerInterface
...
class ServerProtocolTest extends TestCase
{
    ...
    {
        $this->expectException('\Appsaeed\Wamp\Exception');
    ...
    public function testOnClosePropagation()
    {
        ...
        $class  = new \ReflectionClass('\\Appsaeed\\Wamp\\WampConnection');
    ...
    {
        $this->expectException('\\Appsaeed\\Wamp\\JsonException');
    ...
    {
        $app = $this->getMock('\\Appsaeed\\Wamp\\WampServerInterface');
