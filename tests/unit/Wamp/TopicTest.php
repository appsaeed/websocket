...
class TopicTest extends TestCase
{
    ...
    public function testBroadcast()
    {
        ...
        $first  = $this->createMock(WampConnection::class);
        $second = $this->createMock(WampConnection::class);
    ...
    public function testBroadcastWithExclude()
    {
        ...
        $first  = $this->createMock(WampConnection::class);
        $second = $this->createMock(WampConnection::class);
        $third  = $this->createMock(WampConnection::class);
    ...
    {
        return new WampConnection($this->createMock(\Appsaeed\ConnectionInterface::class));
    }
}
